/**
 * Node Categories
 * Defines the categories and their metadata
 */
...
export const categories = [
  { 
    key: 'Triggers', 
    label: 'Triggers', 
    description: 'Start your workflow with triggers' 
  },
  {
    key: 'AI',
    label: 'AI',
  ...
  },
  {
    key: 'Web3',
    label: 'Web3',
    description: 'Read/write smart contracts, transfer tokens, query chains and react to on-chain events'
  },
  { 
    key: 'Chat Models', 
    label: 'Chat Models', 
    description: 'Large language models for conversation and text generation' 
  },
  { 
    key: 'Memory', 
    label: 'Memory', 
  ...
  { 
    key: 'Tools', 
    label: 'Tools', 
    description: 'External tools and utilities for enhanced functionality' 
  },
  { 
    key: 'Actions', 
    label: 'Actions', 
