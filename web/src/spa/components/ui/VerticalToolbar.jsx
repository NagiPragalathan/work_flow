...
import { FiDownload, FiUpload, FiEdit3, FiTrash2, FiZap, FiGrid } from 'react-icons/fi';

const VerticalToolbar = ({ onExport, onImport, onTemplates, onAddNotes, onOpenAI, onClearWorkspace, onMagic }) => {
  return (
    <div className="vertical-toolbar">
      <div className="toolbar-button toolbar-button-primary" title="Browse Templates" onClick={onTemplates}>
        <FiGrid />
      </div>
